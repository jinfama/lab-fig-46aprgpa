...
const state = {
  section: "visualizacion",   // visualizacion | perspectivas | datos | acerca
  subsection: "landing",      // landing | viz   (sólo cuando section=visualizacion)
  categoryId: null,
  year: 2021,
  variable: "Absoluto",
  tipoMulti: ["Total"],
  stacked: false,
  view: "trend",              // trend | map | table
  mapComboId: null,
